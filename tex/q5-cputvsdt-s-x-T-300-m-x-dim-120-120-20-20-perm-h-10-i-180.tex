\begin{figure}[!ht]
\centering
\tikzsetnextfilename{q5_cputime_perm_h_10_m_1_10_i_180}
...
\begin{tikzpicture}
    ...
    \end{semilogyaxis}
\end{tikzpicture}%
\caption{$M =0.1$} \label{fig:q5_cputime_perm_h_10_m_1_10_i_180}
\end{subfigure}%
\vspace{0.3cm}
\centering
\tikzsetnextfilename{q5_cputime_perm_h_10_m_1_1_i_180}
\begin{subfigure}[b]{0.8\textwidth}
\begin{tikzpicture}
    \begin{semilogyaxis}[
            width=0.97\textwidth,
    ...
    \end{semilogyaxis}
\end{tikzpicture}%
\caption{$M =1$} \label{fig:q5_cputime_perm_h_10_m_1_1_i_180}
\end{subfigure}%
\vspace{0.3cm}
\centering
\tikzsetnextfilename{q5_cputime_perm_h_10_m_10_1_i_180}
\begin{subfigure}[b]{0.8\textwidth}
\begin{tikzpicture}
    \begin{semilogyaxis}[
            width=0.97\textwidth,
    ...
    \end{semilogyaxis}
\end{tikzpicture}%
\caption{$M =10$} \label{fig:q5_cputime_perm_h_10_m_10_1_i_180}
\end{subfigure}%
\caption{CPU time used to solve the Q5 problem, Section \ref{section:caseA}, for varying root finders, time steps and viscosity ratios. Note that $\unit[120]{m} \times \unit[120]{m}$ cells are used here.}
\label{fig:q5_cputime_perm_h_10_i_180}
\end{figure}